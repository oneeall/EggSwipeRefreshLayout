...
class EggMaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final EggMaterialProgressDrawable.Ring mRing;
    ...
    EggMaterialProgressDrawable(Context context, View parent) {
        mParent = parent;
        mResources = context.getResources();

        mRing = new EggMaterialProgressDrawable.Ring(mCallback);
    ...
    private void setSizeParameters(double progressCircleWidth, double progressCircleHeight,
        ...
        final EggMaterialProgressDrawable.Ring ring = mRing;
     ...
     *
     */
    public void updateSizes(@EggMaterialProgressDrawable.ProgressDrawableSize int size) {
        if (size == LARGE) {
    ...
    float getMinProgressArc(EggMaterialProgressDrawable.Ring ring) {
     ...
     * the next color.
     */
    void updateRingColor(float interpolatedTime, EggMaterialProgressDrawable.Ring ring) {
    ...
    void applyFinishTranslation(float interpolatedTime, EggMaterialProgressDrawable.Ring ring) {
